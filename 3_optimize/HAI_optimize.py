...
def optimize(obs_days, pred_cases, obs_cases, hai, z_ran, pi_ran):
    ...
    main_df = pd.read_pickle(mydir + "1_data/" + hai + "_Data.pkl")
    ...
    for fdate in fdates:
        ...
        while ct < 5*10**3:
            ...
            if ct == 1 or ct%500 == 0:
                ...
                df.to_pickle(mydir + "1_data/optimized_by_quarter/" + hai + "/" + hai + "_Data_opt_for_SIRs_" + fdate + ".pkl")
                opt_df.to_csv(mydir + "1_data/optimized_by_quarter/" + hai + "/" + hai + "_opt_iterations_" + fdate + ".csv")
