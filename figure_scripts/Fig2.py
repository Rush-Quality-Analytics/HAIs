...
for fdate in fdates:
    ...
    plt.text(0.0*max(x), 0.9*max(y), r'$\overline{r^{2}}$' + ' = ' + str(np.round(np.mean(CAUTI_r2s), 2)) + ' ± ' + str(np.round(np.std(CAUTI_r2s), 3)), fontsize=fs-2)
    ...
    plt.text(0.0*max(x), 0.9*max(y), r'$\overline{r^{2}}$' + ' = ' + str(np.round(np.mean(CLABSI_r2s), 2)) + ' ± ' + str(np.round(np.std(CLABSI_r2s), 3)), fontsize=fs-2)
    plt.text(0.0*max(x), 0.8*max(y), r'$r^{2}$' + ' = ' + str(np.round(r2, 2)), fontsize=fs-2)
    ...
    plt.text(0.0*max(x), 0.9*max(y), r'$\overline{r^{2}}$' + ' = ' + str(np.round(np.mean(MRSA_r2s), 2)) + ' ± ' + str(np.round(np.std(MRSA_r2s), 3)), fontsize=fs-2)
    plt.text(0.0*max(x), 0.8*max(y), r'$r^{2}$' + ' = ' + str(np.round(r2, 2)), fontsize=fs-2)
    ...
    plt.text(0.0*max(x), 0.9*max(y), r'$\overline{r^{2}}$' + ' = ' + str(np.round(np.mean(CDIFF_r2s), 2)) + ' ± ' + str(np.round(np.std(CDIFF_r2s), 3)), fontsize=fs-2)
    plt.text(0.0*max(x), 0.8*max(y), r'$r^{2}$' + ' = ' + str(np.round(r2, 2)), fontsize=fs-2)
    ...
    if fdate == '2020-04-22':
        ...
        fig.savefig(mydir+'/figures/Fig2/Fig2_' + fdate + '.eps', dpi=300, format="eps", bbox_inches = "tight")
